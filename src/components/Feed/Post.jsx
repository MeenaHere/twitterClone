...
function Post({ post, fetchPosts }) {
    ...
    const fetchProfilePhoto = async () => {
        try {
            const response = await axios.get('https://x-twitter-clone-react.netlify.app/posts/random-dog-image');
    ...
    const fetchComments = async () => {
        try {
            const response = await axios.get(`https://x-twitter-clone-react.netlify.app/tweets/${post._id}`);
    ...
    const handleDeleteComment = async (commentId) => {
        try {
            await axios.delete(`https://x-twitter-clone-react.netlify.app/comment/${commentId}`);
    ...
    const handleDeleteReply = async (commentId, replyId) => {
        try {
            await axios.delete(`https://x-twitter-clone-react.netlify.app/comment/${commentId}/reply/${replyId}`);
            fetchComments(); // Refresh comments after deletion
        } catch (error) {
